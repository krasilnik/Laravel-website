            ...
            <div class="content">
                ...
                <div class="tide-content">
                    ...
                    <div class="dishes-list">
                        <div class="dish-card">
                            <p class="dish-name"><?php echo e($first_article->title); ?></p>
                            <p class="dish-description">
                                <?php echo e($first_article->text); ?>

                            </p>
                            <img class="dish-image" src="<?php echo e($first_article->image); ?>" alt="dish-image">
                            <p class="dish-info">
                                <span class="red">Адреса:</span><?php echo e($first_article->address); ?><br><br>
                                <span class="red">Телефон:</span> <?php echo e($first_article->phone); ?>
...
<?php echo $__env->make('layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\Bitnami\wampstack-8.0.20-0\apache2\htdocs\yumukr\resources\views/restaurant.blade.php ENDPATH**/ ?>